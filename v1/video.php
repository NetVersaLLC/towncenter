...
<!-- End Visual Website Optimizer Asynchronous Code -->
				...
				<div class="container">
					<div class="row-fluid span12">
						<div class="des_div">
							...
							<div class="des_r">
								<p class="des_sub_txt">Increase your visibility</p>
								<p class="des_sub_txt">SCAN NOW</p>
							</div>
						</div>
					</div>
					<div class="row-fluid span12">
						<div class="des_content">
							<div class="span7">
								<div class="des_content_txt">
									<p class="des_title">Reviews and Testimonials</p>
									<p class="des_con_txt"><b>Advanced technology</b></p>
                                    
                                  <p class="des_con_txt">    <video id="my_video_1" class="video-js vjs-default-skin" controls
  ...
  <source src="my_video.webm" type='video/webm'>
									...
									<p class="des_con_txt">We invest in the best possible engineering talent so<br>that our products are cutting edge and constantly innovating.</p>
									<div class="b20"></div>
									<p class="des_con_txt"><b>Direct API integration</b></p>
									<p class="des_con_txt">Connect directly with major location sites so<br>that updates are frictionless from your team to your customers.</p>
								</div>
							</div>
							<div class="span5"></div>
						</div>
